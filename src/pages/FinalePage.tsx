...
import { HeartbeatText, SparkleText } from '../components/MicroAnimations'
        ...
        >
          ...
          <AnimatePresence>
            {showFinalLine && (
              ...
              >
                Stay the <SparkleText>Baddie</SparkleText> you are, <HeartbeatText>Nimisha</HeartbeatText>. 💖
              </motion.p>
            )}
          </AnimatePresence>
        </motion.div>
        ...
        {showFinalLine && (
          ...
          >
            <div className="flex flex-col md:flex-row gap-4 items-center justify-center">
              ...
              <motion.button
                onClick={() => navigate('/')}
                className="px-8 py-4 bg-white/80 text-pink-600 rounded-full text-lg md:text-xl font-semibold shadow-lg hover:shadow-pink-500/50 transition-all duration-300"

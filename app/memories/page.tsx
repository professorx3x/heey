        ...
        {memories.map((memory, index) => (
          ...
          >
            ...
            >
              {/* Front of card */}
              <motion.div
                className={`absolute inset-0 bg-gradient-to-br ${memory.color} rounded-3xl shadow-2xl flex items-center justify-center backface-hidden border-4 border-white/50`}
              ...
              {/* Back of card */}
              <motion.div
                className={`absolute inset-0 bg-gradient-to-br ${memory.color} rounded-3xl shadow-2xl flex items-center justify-center backface-hidden border-4 border-white/50 p-6`}
